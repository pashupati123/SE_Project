<%@ Page Language="C#" Theme="Theme1"  MasterPageFile="~/AgricultureOfficer/OfficerMasterPage.master" AutoEventWireup="true" CodeFile="frmOfficersShowOutBoxDetails.aspx.cs" Inherits="AgricultureOfficer_frmOfficersShowOutBoxDetails" Title="Untitled Page" %>
...
<legend>Display OutBox Details</legend>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align=left>
            <h4>
           <a href="frmOfficersOutBox.aspx" >Back</a>
             </h4>
            </td>
            </tr>
            <tr>
