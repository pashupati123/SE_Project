<%@ Page Language="C#" MasterPageFile="~/AgricultureOfficer/OfficerMasterPage.master" AutoEventWireup="true" CodeFile="frmOffricerChatRoom.aspx.cs" Inherits="AgricultureOfficer_frmOffricerChatRoom" Title="Untitled Page" %>
                    ...
                    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                     ...
                     <asp:AsyncPostBackTrigger ControlID="Timer1" EventName="" />
                        ...
                        <ContentTemplate>
                            <table width="100%">
                                <tr>
                                <td><b>Faculties available to chat</b></td>
                                </tr>
                                <tr>
                                 ...
                                 <tr>
                                <td><b>Students available to chat</b></td>
                                </tr>
                                <tr>
                                    <td align="left" style="text-align: center">
