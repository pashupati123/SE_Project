<%@ Page Language="C#" Theme="Theme1"  MasterPageFile="~/AgricultureOfficer/OfficerMasterPage.master" AutoEventWireup="true" CodeFile="frmOfficersShowInboxDetails.aspx.cs" Inherits="AgricultureOfficer_frmOfficersShowInboxDetails" Title="Untitled Page" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <center>
<fieldset id="Field1" runat ="server" style="width:600px">
<legend>Read Your Mails</legend>
        ...
        <table width="80%" border="1" style="border-color: #5A5D5A; border-width: 1px;">
            ...
            <td align="left">
            <h4>
             <a href="frmOfficersInBox.aspx" >Back</a>
             </h4>
            </td>
            </tr>
            <tr>
